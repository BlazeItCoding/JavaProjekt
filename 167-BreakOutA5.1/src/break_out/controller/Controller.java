 ...
 * 
 * @author dmlux, modified by I. Schumacher, I. Traupe, Maren Mainusch and Martin Stuwe
 * 
 */
public class Controller implements ActionListener, KeyListener {
	 ...
	 * Every time the user pushes a key the KeyListener (this 
	 * controller) gets an KeyEvent.
	 */
	...
	public void keyPressed(KeyEvent e) {
		...
		/*
		 *  Stops/starts the ball if Space has been pressed.
		 */
		...
		/*
		 *  Moves the paddle DX_MOVEMENT pixel to the left if the left arrow key is pressed
		 */
		...
		/*
		 * Moves the paddle DX_MOVEMENT pixel to the right if the right arrow key is pressed.
		 */
		...
		/*
		 * Ends the level and goes back to the start screen if ESC has been pressed.
		 */
		if (e.getKeyCode()==KeyEvent.VK_ESCAPE ) {
			game.getLevel().setFinished();
			toStartScreen();
		}
	}
	...
	public void keyReleased(KeyEvent e) {
		...
		/*
		 *  Stops the balls movement if the left or right arrow has been released.
		 */
